...
(function(){
	...
	const parameterFakeTypes = {
		preference: function (originalValue, definition, window, prefs) {
			// Override specific preferences with hardcoded values
			if (definition.preferenceName === "webGLUnmaskedVendor") {
				return "CustomVendor_from_WEBGL_!"; // Replace with your desired vendor name
			}
			if (definition.preferenceName === "webGLUnmaskedRenderer") {
				return "CustomRenderer_from_WEBGL_!"; // Replace with your desired renderer name
			}
	
			// Default behavior for other preferences
